...
export function isKoreanDirector(s) {
...
// structurally valid codes (e.g. "cn") pass through unchanged.
...
// js-yaml dump options that approximate PyYAML's
//   yaml.dump(..., allow_unicode=True, sort_keys=False)
// as used by data-manager.py:543-544.
//
...
// - noCompatMode: true → use modern YAML 1.2-ish output, closer to PyYAML
