...
// the six curated awards. Awards OUTSIDE that set (César, Hong Kong, IIFA,
// Japan Academy) are preserved untouched. See cli/reconcile-awards.mjs.

import { AWARD_QID_TO_NAME, BLUE_DRAGON_AWARD_NAME } from "./awards_curation.js";

// The six awards awards.yml is authoritative over — the exact AWARD_NAMES
// strings (curly apostrophe in Venice, Korean Blue Dragon name) so set
// membership matches movies.yml byte-for-byte.
