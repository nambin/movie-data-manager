...
export const DEFAULT_GEMINI_MODEL = "flash";

function geminiEndpoint(model) {
  const modelId = GEMINI_MODELS[model] ?? GEMINI_MODELS[DEFAULT_GEMINI_MODEL];
...
async function callGemini({ systemPrompt, userPrompt, schema, apiKey, model }) {
...
export async function parseMemoLine(line, apiKey, model) {
  return callGemini({
...
export async function matchTmdbCandidate({
  rawLine,
  parsed,
  candidates,
  apiKey,
